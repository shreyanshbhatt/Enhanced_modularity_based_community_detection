...
class FMeasureCesna {
  public void readFileInDS(String fileName, HashMap<Integer, ArrayList<String>> ds) throws Exception {
  ...
  public double computeFMeasure(String groundTruth, String detected) throws Exception {
    ...
    for (int dt : dtCNMembership.keySet()) {
      ...
      //total_f1_score += (double)((max_f1_score * dtCNMembership.size())/ (double)((double)total_nodes));
...
public class CommunityFMeasureCesna {
  ...
  public double measureFScore(int id, String detected) throws Exception {
    ...
    double one_way = fmc.computeFMeasure("facebook/newCircles"+id, detected);
    double other = fmc.computeFMeasure(detected, "facebook/newCircles"+id);
